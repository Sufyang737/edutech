...
export const metadata: Metadata = {
  title: "Lingo | Tabla de Posiciones",
  description: "Mira cómo te posicionas entre otros estudiantes de la comunidad.",
};
      ...
      <FeedWrapper>
        <div className="flex w-full flex-col items-center">
          ...
          <p className="mb-6 text-center text-lg text-muted-foreground">
            Mira cómo te posicionas entre otros estudiantes de la comunidad.
          </p>
